...
(doom! :input
       ...
       (corfu +icons +orderless +dabbrev)  ; popup completion, like nvim-cmp
       ;;helm              ; the *other* search engine for love and life
       ;;ido               ; the other *other* search engine...
       ;;ivy               ; a search engine for love and life
       (vertico +icons)  ; minibuffer/file/project search, like Telescope
       ...
       (format +onsave)  ; automated prettiness (prettier/black via Apheleia)
       ...
       ;;(java +lsp)       ; the poster child for carpal tunnel syndrome
        (javascript +lsp +tree-sitter) ; JS/TS/JSX/TSX + prettier + LSP
